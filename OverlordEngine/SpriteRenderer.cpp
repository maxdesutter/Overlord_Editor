...
void SpriteRenderer::InitRenderer(ID3D11Device* pDevice)
{
	...
	m_pEffect = ContentManager::Load<ID3DX11Effect>(L"./../OverlordProject/Resources/Effects/SpriteExRenderer.fx");
#else
	m_pEffect = ContentManager::Load<ID3DX11Effect>(L"./../OverlordProject/Resources/Effects/SpriteRenderer.fx");
#endif
