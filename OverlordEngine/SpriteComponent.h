...
class SpriteComponent : public BaseComponent
{
	...
	TextureStruct* m_Texture = nullptr;
...
public:
	...
	SpriteComponent(TextureStruct*  spriteAsset, DirectX::XMFLOAT2 pivot = DirectX::XMFLOAT2(0, 0),
		DirectX::XMFLOAT4 color = static_cast<DirectX::XMFLOAT4>(DirectX::Colors::White));
	...
	TextureStruct* GetTextureStruct() { return m_Texture; };
protected:
