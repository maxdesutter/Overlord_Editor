...
{
	m_MaterialTypeName = L"Spikey material";

	RegisterVariable<TextureStruct*>(this, &SpikeyMaterial::GetTextureStruct, &SpikeyMaterial::SetTextureStruct, "Texture");
}
...
void SpikeyMaterial::SetTextureStruct(TextureStruct* str)
{
	m_textureStruct = str;
	m_pDiffuseTexture = ContentManager::Load<TextureData>(str->path);
