...
public:
	...
	bool GetDiffuseTextureENabled() { return m_bDiffuseTexture; }

	
	void SetDiffuseTexture(const std::wstring& assetFile);
	void SetDiffuseColor(DirectX::XMFLOAT4 color);

	void SetDiffuseTextureStruct(TextureStruct* texture);
	TextureStruct* GetDiffuseTextureStruct() { return m_pDiffuseTexStrut; }

	DirectX::XMFLOAT4 GetDiffuseColor() { return m_ColorDiffuse; }
	//SPECULAR
	//********
	...
	void SetSpecularLevelTextureStruct(TextureStruct* texture);
	...
	void SetNormalMapTextureStruct(TextureStruct* texture);

	//ENVIRONMENT MAPPING
	//*******************
	void EnableEnvironmentMapping(bool enable);
	void SetEnvironmentCube(const std::wstring& assetFile);
	void SetEnvironmentCubeStruct(TextureStruct* texture);
	...
	void SetOpacityTextureStruct(TextureStruct* texture);
...
private:
 ...
 DirectX::XMFLOAT3 m_LightDirection;
	...
	std::wstring m_DiffuseTexturePath;
	TextureStruct* m_pDiffuseTexStrut = nullptr;
 ...
 DirectX::XMFLOAT4 m_ColorSpecular;
	...
	std::wstring m_SpecularTexturePath;
	TextureStruct* m_SpecularTextureStruct = nullptr;
 ...
 DirectX::XMFLOAT4 m_ColorAmbient;
	...
	TextureStruct* m_NormalTextureStruct = nullptr;
	...
	std::wstring m_EnviromentTexturePath;
	TextureStruct* m_EnviromentTextureStruct = nullptr;
	...
	std::wstring m_OpacityTexturePath;
	TextureStruct* m_OpacityTextureStruct = nullptr;
